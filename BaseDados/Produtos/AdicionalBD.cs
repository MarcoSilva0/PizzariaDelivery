        ...
        public bool Inserir(Adicional oAdicional)
        {
            ...
            using (MySqlConnection conexao = ConexaoBaseDados.getInstancia().getConexao())
            {
                try
                {
                    ...
                    adicional(descricao, observacao, valor, situacao, dt_alteracao, codigo_usr_alteracao) 
                    VALUES 
                           (@descricao, @observacao, @valor, @situacao, NOW(), @codigo_usr_alteracao) ";
        ...
        public bool Alterar(Adicional oAdicional)
        {
            ...
            using (MySqlConnection conexao = ConexaoBaseDados.getInstancia().getConexao())
            {
                try
                {
                    ...
                    comando.CommandText = @"UPDATE adicional SET descricao = @descricao,
                                             observacao = @observacao, valor = @valor, situacao = @situacao,
                                             dt_alteracao = NOW(),
