        ...
        public bool Inserir(SaborPizza oSaborPizza)
        {
            ...
            using (MySqlConnection conexao = ConexaoBaseDados.getInstancia().getConexao())
            {
                try
                {
                    ...
                    sabor_pizza(descricao, observacao, valor_adicional, situacao, dt_alteracao, codigo_usr_alteracao) 
                    VALUES 
                           (@descricao, @observacao, @valor_adicional, @situacao, NOW(), @codigo_usr_alteracao) ";
        ...
        public bool Alterar(SaborPizza oSaborPizza)
        {
            ...
            using (MySqlConnection conexao = ConexaoBaseDados.getInstancia().getConexao())
            {
                try
                {
                    ...
                    comando.CommandText = @"UPDATE sabor_pizza SET descricao = @descricao,
                                             observacao = @observacao, valor_adicional = @valor_adicional, situacao = @situacao,
                                             dt_alteracao = NOW(),
